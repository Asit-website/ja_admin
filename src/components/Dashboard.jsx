      ...
      <ul class="space-y-2 font-medium">
         ...
         <li >
            ...
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">View Student</span>
            </a>
         </li>
         ...
         >
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Create Student</span>
            </a>
         </li>
...
<div class="p-4 sm:ml-64  min-h-[100vh]">
   ...
   {
    selectedItem === "createStudent" && 
 <CreateStudent setSelectedItem={setSelectedItem}  />
   }

   {
      selectedItem === "viewStudent"  && 
     <AllUsers  />
